...
// Fetch blotter report at naka desc order para yung pinakabago ang nasa taas sa pamamagitan nung created_at
$blotter_query = "
    ...
    ORDER BY 
        CASE 
            WHEN br.status = 'finished' THEN 1 
            ELSE 0 
        END, 
        br.created_at DESC
";
...
<?php include 'admin_sidenav.php'; ?> 
    ...
    function confirmAssign(blotterId) {
        ...
        // Sweet alert para required na may laman muna yung date and time
