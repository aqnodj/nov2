...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 02, 2024 at 01:13 AM
...
(129, 'si jv ay hinabol ng aso\r\n\r\ntulungan nyo1211\n\n(edited)', '2024-10-29 00:40:42'),
(130, 'aaaaaaaaaaaaaaaaaassd\r\n12\r\nSADasdasdasaaasdaasd\n\n(edited)', '2024-10-29 00:43:09'),
(132, 'asdas', '2024-10-29 00:53:59');
...
(1, 'Novilito M. Manalo', 'Barangay Captain'),
...
CREATE TABLE `blotter_report` (
  ...
  `status` enum('pending','canceled','assigned','finished') NOT NULL DEFAULT 'pending',
...
(102, 69, 'Boring ng mga lalaki', 'Bored lang', 'assigned', '2024-11-01', '20:30:00', '2024-10-31 06:35:07'),
(103, 56, 'asdasd', 'asdsad', 'pending', NULL, NULL, '2024-11-01 19:06:23');
...
(31, 'nga', 'asdsad', 'a', '21323a', 'staff@gmail.com', '$2y$10$Ksf2fwjK/SJmVLfoxTvWHejy82E2UV/6sEQG/9gDFcSAtPpysC5qy', '23', 'male', 2);
...
(56, 'Nilsasadaaa', 'asdsa', 'Martija', '', 1, 654216441, 'nils@gmail.com', '$2y$10$Isf5iedVS/E2CRcTVnaS.eTBWlm7Z.SkJ15eYx4tw3UNueEWzG7du', 3, '2024-10-27 02:19:26', NULL, NULL, 0, NULL),
...
--
ALTER TABLE `blotter_report`
  MODIFY `blotter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;
