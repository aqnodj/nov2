            ...
            <div class="col-lg-12">
                ...
                <div class="list-group" id="announcementList">
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<button class='btn btn-primary btn-sm me-2' onclick='editAnnouncement(" . $row['id'] . ", " . json_encode($row['message']) . ")'>Update</button>";
                        echo "<a href='announcement.php?delete_id=" . $row['id'] . "' class='btn btn-danger btn-sm' onclick='return confirmDelete(event)'>Delete</a>";
                        echo "</div>";
                        echo "</div>";
                    }
                    ?>
